...
class _FixedTermScreenState extends State<FixedTermScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body:  GetBuilder<FixedTermController>(builder: (FixedTermController) {
        return FixedTermController.fixedProjectProgress
            ? const Center(
          child: CircularProgressIndicator(),
        )
            : RefreshIndicator(
          onRefresh: () async {
            FixedTermController.getFixedTermProcect();
          },
          child: Column(
            children: FixedTermController.FixedProjectDataModel.data!
                .map((e) =>  Row(
